...
>
  Download CV
                ...
                <a
                  href="#projects"
                  className="rounded-lg border border-gray-300 dark:border-gray-700 px-6 py-3 font-semibold text-black dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 transition"
                >
                  See My Work
                </a>
              </div>
              ...
              <div className="mt-12">
                ...
                <div className="mt-4 flex flex-wrap gap-4">
                  <span className="rounded-lg bg-black dark:bg-white px-4 py-2 text-sm font-medium text-white dark:text-black">
                    Faster
                  </span>
                  <span className="rounded-lg bg-black dark:bg-white px-4 py-2 text-sm font-medium text-white dark:text-black">
                    Handsome
